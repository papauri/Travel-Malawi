const fs = require('fs');
let code = fs.readFileSync('src/pages/ListProperty.tsx', 'utf8');
...
// Update Room Gallery
code = code.replace(
  `                      hint="These photos appear in the image carousel when a guest clicks to view more details about this room type. Add photos of the en-suite bathroom, the view from this room, and specific room amenities."`,
...
fs.writeFileSync('src/pages/ListProperty.tsx', code);
