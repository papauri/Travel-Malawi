...
with open('src/components/DirectionsPanel.tsx', 'r', encoding='utf-8') as f:
    text = f.read()
...
with open('src/components/DirectionsPanel.tsx', 'w', encoding='utf-8') as f:
    f.write(text)
print("Cleaned DirectionsPanel.tsx")
